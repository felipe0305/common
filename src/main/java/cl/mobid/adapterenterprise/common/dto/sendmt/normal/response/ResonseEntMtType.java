...
/**
 * <p>Java class for resonseEntMtType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="resonseEntMtType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="detailResEntMt" type="{http://www.mobid.cl/adapter/common/dto/sendsms/response}itemDetailResEntMtType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "resonseEntMtType", propOrder = {
    "generalCode",
    "generalMessage",
    "detailResEntMt"
})
public class ResonseEntMtType {

    protected int generalCode;
    @XmlElement(required = true)
    protected String generalMessage;
    protected List<ItemDetailResEntMtType> detailResEntMt;
     ...
     * {@link ItemDetailResEntMtType }
     * 
     * 
     */
    public List<ItemDetailResEntMtType> getDetailResEntMt() {
        if (detailResEntMt == null) {
            detailResEntMt = new ArrayList<ItemDetailResEntMtType>();
        }
