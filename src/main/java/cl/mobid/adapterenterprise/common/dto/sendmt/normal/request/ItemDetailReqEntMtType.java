...
/**
 * <p>Java class for itemDetailReqEntMtType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="itemDetailReqEntMtType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="listDataClient" type="{http://www.mobid.cl/adapter/common/dto/sendsms/request}itemDataClientType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "itemDetailReqEntMtType", propOrder = {
    "numberMobil",
    "sendDate",
    "message",
    "clientCode",
...
public class ItemDetailReqEntMtType {
    ...
    protected List<ItemDataClientType> listDataClient;
     ...
     * {@link ItemDataClientType }
     * 
     * 
     */
    public List<ItemDataClientType> getListDataClient() {
        if (listDataClient == null) {
            listDataClient = new ArrayList<ItemDataClientType>();
        }
